    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/dashboard/regist_procedure/save') ?>" method="post">
                        <?= csrf_field() ?>

                        <div class="form-group">
                            <label for="procedure">Prosedur</label>
                            <textarea name="procedure" rows="3" class="form-control <?= ($validation->hasError('procedure')) ? 'is-invalid' : '' ?>" placeholder="Prosedur" style="height:auto"><?= old('procedure') ?></textarea>
