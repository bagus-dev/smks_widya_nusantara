                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane container active" id="basic">
                            <div class="row">
                                <div class="col">
                                    <form action="<?= base_url('admin/dashboard/account/basic/save') ?>" method="post">
                                        <?= csrf_field(); ?>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="phone" class="form-control <?= ($validation->hasError('phone')) ? 'is-invalid' : ''; ?>" placeholder="Nomor HP" value="<?= (old('phone')) ? old('phone') : $profile->phone ?>">
                        ...
                        <div class="tab-pane container fade" id="image">
                            <div class="row">
                                <div class="col-md-5 pt-2">
                                    ...
                                    <img src="<?= base_url().'/assets/img/admin/'.$profile->image; ?>" alt="Foto Profil" class="img-fluid" id="pp-settings">
                                </div>
                                <div class="col-md-7 pt-2">
                                    <h5>Ganti Foto Profil:</h5>
                                    <form action="/admin/dashboard/account/image/save" method="post" enctype="multipart/form-data">
                                        <?= csrf_field(); ?>
